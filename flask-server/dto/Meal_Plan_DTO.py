...
class Meal_Plan_DTO(Base_DTO):
    def __init__(self, meal_plan_json: dict = None, meal_plan_domain: 'Meal_Plan_Domain' = None) -> None:
        if meal_plan_json:
            ...
            self.stated_caloric_lower_bound: int = meal_plan_domain.stated_caloric_lower_bound
            self.stated_caloric_upper_bound: int = meal_plan_domain.stated_caloric_upper_bound
            self.number_of_snacks: int = meal_plan_domain.number_of_snacks
            self.per_snack_caloric_lower_bound: int = meal_plan_domain.per_snack_caloric_lower_bound
            self.per_snack_caloric_upper_bound: int = meal_plan_domain.per_snack_caloric_upper_bound
