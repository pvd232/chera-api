...
class Extended_Staged_Schedule_Meal_DTO(Staged_Schedule_Meal_DTO):
    def __init__(self, extended_staged_schedule_meal_domain: Extended_Staged_Schedule_Meal_Domain = None) -> None:
        super().__init__(staged_schedule_meal_domain=extended_staged_schedule_meal_domain)
