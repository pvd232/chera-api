...
class Dietitian_Prepayment_DTO(Base_DTO):
    def __init__(
        self,
        dietitian_prepayment_json: Optional[dict] = None,
        dietitian_prepayment_domain: Optional["Dietitian_Prepayment_Domain"] = None,
    ) -> None:
        if dietitian_prepayment_json:
            ...
            self.sales_tax_percentage = dietitian_prepayment_json[
            ...
            self.stripe_payment_intent_id = dietitian_prepayment_json[
