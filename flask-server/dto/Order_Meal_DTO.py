...
class Order_Meal_DTO(Base_DTO):
    def __init__(self, order_meal_json: dict = None, order_meal_domain: 'Order_Meal_Domain' = None) -> None:
        if order_meal_json:
            ...
            self.scheduled_order_meal_id: UUID = order_meal_domain.scheduled_order_meal_id
            self.meal_subscription_invoice_id: UUID = order_meal_domain.meal_subscription_invoice_id
