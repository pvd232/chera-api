...
class Recipe_Ingredient_Nutrient_DTO(Base_DTO):
    def __init__(
        self,
        recipe_ingredient_nutrient_json: Optional[dict] = None,
        recipe_ingredient_nutrient_domain: "Recipe_Ingredient_Nutrient_Domain" = None,
    ) -> None:
        ...
        if recipe_ingredient_nutrient_json:
            ...
            self.usda_nutrient_daily_value_amount: float = float(
                recipe_ingredient_nutrient_json["usda_nutrient_daily_value_amount"]
            )
            ...
            self.usda_nutrient_daily_value_amount: float = (
