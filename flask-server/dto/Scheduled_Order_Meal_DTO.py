...
class Scheduled_Order_Meal_DTO(Base_DTO):
    def __init__(self, scheduled_order_meal_json: dict = None, scheduled_order_meal_domain: 'Scheduled_Order_Meal_Domain' = None) -> None:
        if scheduled_order_meal_json:
            ...
            self.meal_id: str = scheduled_order_meal_json["meal_id"]
            ...
            self.meal_subscription_id: UUID = scheduled_order_meal_domain.meal_subscription_id
            self.meal_id: str = scheduled_order_meal_domain.meal_id
