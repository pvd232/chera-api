...
class Meal_Dietary_Restriction_DTO(Base_DTO):
    def __init__(self, meal_dietary_restriction_json: dict = None, meal_dietary_restriction_domain: 'Meal_Dietary_Restriction_Domain' = None) -> None:
        if meal_dietary_restriction_json:
            ...
            self.dietary_restriction_id: str = meal_dietary_restriction_domain.dietary_restriction_id
