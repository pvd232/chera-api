...
class Meal_Plan_Meal_Service(object):
    ...
    def update_meal_plan_meals(
        self,
        meal_plan_meals: list[dict],
        ...
        for meal_plan_meal_domain in meal_plan_meal_domains:
            odd_meal_plan: Meal_Plan_Domain = Meal_Plan_Domain(
                ...
                .filter(Meal_Plan_Model.id == meal_plan_meal_domain.meal_plan_id)
                .first()
            )
            ...
            even_meal_plan_meal: Meal_Plan_Meal_Domain = Meal_Plan_Meal_Domain(
                meal_plan_meal_object=self.db.session.query(Meal_Plan_Meal_Model)
                .filter(
                    Meal_Plan_Meal_Model.meal_id == meal_plan_meal_domain.meal_id,
                    Meal_Plan_Meal_Model.meal_plan_id == even_meal_plan.id,
                )
                .first()
            )
