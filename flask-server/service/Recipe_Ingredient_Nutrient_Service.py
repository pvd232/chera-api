...
class Recipe_Ingredient_Nutrient_Service(object):
    def __init__(self, recipe_ingredient_nutrient_repository: 'Recipe_Ingredient_Nutrient_Repository') -> None:
        self.recipe_ingredient_nutrient_repository = recipe_ingredient_nutrient_repository

    def get_recipe_ingredient_nutrients(self, recipe_ingredient_id: UUID) -> list[Recipe_Ingredient_Domain]:
        recipe_ingredient_nutrient_domains = [Recipe_Ingredient_Nutrient_Domain(
            recipe_ingredient_nutrient_object=x) for x in self.recipe_ingredient_nutrient_repository.get_recipe_ingredient_nutrients(recipe_ingredient_id=recipe_ingredient_id)]
        return recipe_ingredient_nutrient_domains

    def create_recipe_ingredient_nutrients(self, recipe_ingredient_dtos: list['Recipe_Ingredient_DTO'], meal_plan_meal_service: 'Meal_Plan_Meal_Service', usda_ingredient_service: 'USDA_Ingredient_Service', usda_ingredient_portion_service: 'USDA_Ingredient_Portion_Service', usda_ingredient_nutrient_service: 'USDA_Ingredient_Nutrient_Service', nutrient_service: 'Nutrient_Service', usda_nutrient_daily_value_service: 'USDA_Nutrient_Daily_Value_Service') -> None:
        ...
        meal_plan_id = meal_plan_meal_service.get_meal_plan_meal(
            meal_plan_meal_id=recipe_ingredient_domains[0].meal_plan_meal_id).meal_plan_id
        ...
        for recipe_ingredient_domain in recipe_ingredient_domains:
            ...
            recipe_ingredient_grams = usda_ingredient_portion.grams_per_non_metric_unit * \
                recipe_ingredient_domain.quantity

            # get ratio of recipe ingredient grams to usda ingredient grams
            recipe_ingredient_grams_to_usda_ingredient_grams_ratio = recipe_ingredient_grams / \
                usda_ingredient_domain.amount_of_grams

            # get usda ingredient nutrients
            usda_ingredient_nutrients = usda_ingredient_nutrient_service.get_usda_ingredient_nutrients(
            ...
            for usda_nutrient in usda_ingredient_nutrients:
                ...
                nutrient_amount = usda_nutrient.amount * \
                ...
                if not nutrient.has_daily_value:
                    ...
                    usda_nutrient_daily_value_amount = usda_nutrient_daily_value_service.get_usda_nutrient_daily_value(
                        nutrient_id=usda_nutrient.nutrient_id, meal_plan_id=meal_plan_id).amount
    ...
    def helper_update_recipe_ingredient_nutrients(self, recipe_ingredient_dtos: list['Recipe_Ingredient_DTO'], recipe_ingredient_service: 'Recipe_Ingredient_Service', ) -> None:
        nutrients_to_update = []
        updated_recipe_ingredient_domains = [Recipe_Ingredient_Domain(
            recipe_ingredient_object=x) for x in recipe_ingredient_dtos]
        original_recipe_ingredient_domains = recipe_ingredient_service.get_meal_plan_meal_recipe_ingredients(
        ...
        for original_recipe_ingredient in original_recipe_ingredient_domains:
            original_recipe_ingredient_dict[original_recipe_ingredient.id] = original_recipe_ingredient
        ...
        for updated_recipe_ingredient in updated_recipe_ingredient_domains:
            ...
            if original_recipe_ingredient.quantity != updated_recipe_ingredient.quantity:
                ...
                for recipe_ingredient_nutrient in recipe_ingredient_nutrients:
                    recipe_ingredient_nutrient.amount = recipe_ingredient_nutrient.amount * \
    ...
    def update_recipe_ingredient_nutrients(self,  recipe_ingredient_dtos: list['Recipe_Ingredient_DTO'], recipe_ingredient_service: 'Recipe_Ingredient_Service') -> None:
        nutrients_to_update = self.helper_update_recipe_ingredient_nutrients(
            recipe_ingredient_dtos=recipe_ingredient_dtos, recipe_ingredient_service=recipe_ingredient_service)
    ...
    def write_recipe_ingredient_nutrients(self) -> None:
        with open("new_recipe_ingredient_nutrients.json", "r+") as outfile:
            recipe_ingredient_nutrient_dtos = [x.dto_serialize()
                                               for x in self.get_recipe_ingredient_nutrients()]
            ...
            if data:
                ...
                outfile.write(json.dumps(
                    recipe_ingredient_nutrient_dtos, indent=4))
