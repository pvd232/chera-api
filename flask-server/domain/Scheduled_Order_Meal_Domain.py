...
class Scheduled_Order_Meal_Domain(Base_Domain):
    def __init__(
        self,
        scheduled_order_meal_object: Optional[
            Scheduled_Order_Meal_Model | Scheduled_Order_Meal_DTO
        ],
        schedule_meal_object: Optional[Schedule_Meal_Domain],
        scheduled_order_meal_id: Optional[UUID],
        ...
        if scheduled_order_meal_object:
            ...
            self.meal_subscription_id: UUID = (
                scheduled_order_meal_object.meal_subscription_id
            )
            ...
            self.datetime: float = datetime.now(timezone.utc).timestamp()
