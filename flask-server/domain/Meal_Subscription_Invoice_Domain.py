...
class Meal_Subscription_Invoice_Domain(Base_Domain):
    def __init__(self, meal_subscription_invoice_object: Meal_Subscription_Invoice_Model | Meal_Subscription_Invoice_DTO) -> None:
        self.id: UUID = meal_subscription_invoice_object.id
        self.meal_subscription_id: UUID = meal_subscription_invoice_object.meal_subscription_id
        self.subtotal: float = meal_subscription_invoice_object.subtotal
        self.sales_tax_percentage: float = meal_subscription_invoice_object.sales_tax_percentage
        ...
        self.stripe_payment_intent_id: str = meal_subscription_invoice_object.stripe_payment_intent_id
