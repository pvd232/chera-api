...
from .Extended_Meal_Domain import Extended_Meal_Domain
...
class Extended_Scheduled_Order_Meal_Domain(Scheduled_Order_Meal_Domain):
    def __init__(self, scheduled_order_meal_model: 'Scheduled_Order_Meal_Model') -> None:
        ...
        self.associated_meal = Extended_Meal_Domain(
            meal_model=scheduled_order_meal_model.associated_meal)
